...
func TestParseOSVScannerResults_FileDoesNotExist(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/does-not-exist")
...
func TestParseOSVScannerResults_InvalidJSON(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/not-json.txt")
...
func TestParseOSVScannerResults_NoPackages(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/empty.json")
...
func TestParseOSVScannerResults_OnePackage(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/one-package.json")
...
func TestParseOSVScannerResults_OnePackageCommit(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/one-package-commit.json")
...
func TestParseOSVScannerResults_MultiPackages(t *testing.T) {
	...
	packages, err := extractor.ParseOSVScannerResults("fixtures/osvscannerresults/multi-packages-with-vulns.json")
