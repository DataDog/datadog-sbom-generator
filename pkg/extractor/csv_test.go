...
func TestFromCSVRows(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := extractor.FromCSVRows(tt.args.filePath, tt.args.parseAs, tt.args.rows)
			if err != nil {
...
func TestFromCSVRows_Errors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := extractor.FromCSVRows(tt.args.filePath, tt.args.parseAs, tt.args.rows)
...
func TestFromCSVFile(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := extractor.FromCSVFile(tt.args.pathToCSV, tt.args.parseAs)
			if err != nil {
				t.Errorf("FromCSVFile() error = %v, was not expected", err)
...
func TestFromCSVFile_Errors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := extractor.FromCSVFile(tt.args.pathToCSV, tt.args.parseAs)
