...
func TestGradleVerificationMetadataExtractor_ShouldExtract(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			e := java.GradleVerificationMetadataExtractor{}
...
func TestParseGradleVerificationMetadata_FileDoesNotExist(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/does-not-exist")
...
func TestParseGradleVerificationMetadata_InvalidXml(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/not-xml.txt")
...
func TestParseGradleVerificationMetadata_NoPackages(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/empty.xml")
...
func TestParseGradleVerificationMetadata_OnePackage(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/one-package.xml")
...
func TestParseGradleVerificationMetadata_OnePackage_MatcherFailed(t *testing.T) {
	...
	java.GradleVerificationExtractor.Matchers = []extractor.Matcher{testutil.FailingMatcher{Error: matcherError}}

	path := filepath.FromSlash(filepath.Join(dir, "../fixtures/gradle-verification-metadata/one-package.xml"))
	packages, err := java.ParseGradleVerificationMetadata(path)
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestParseGradleVerificationMetadata_MultipleVersions(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/multiple-versions.xml")
...
func TestParseGradleVerificationMetadata_Complex(t *testing.T) {
	...
	packages, err := java.ParseGradleVerificationMetadata("../fixtures/gradle-verification-metadata/complex.xml")
