...
func (m BuildGradleMatcher) GetSourceFile(sourceFile extractor.DepFile) (extractor.DepFile, error) {
...
func (m BuildGradleMatcher) Match(sourceFile extractor.DepFile, packages []extractor.PackageDetails, context extractor.ScanContext) error {
...
func (m BuildGradleMatcher) matchFileContent(content []byte, sourcePath string, packages []extractor.PackageDetails) {
...
var _ extractor.Matcher = BuildGradleMatcher{}
