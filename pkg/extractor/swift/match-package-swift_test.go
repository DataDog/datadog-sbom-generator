...
import (
	...
	"github.com/DataDog/datadog-sbom-generator/pkg/extractor/swift"
...
func TestPackageSwiftMatcher_GetSourceFile_FileDoesNotExist(t *testing.T) {
	...
	lockFile, err := extractor.OpenLocalDepFile("../fixtures/swift/one-package-v2.json")
	if err != nil {
...
func TestPackageSwiftMatcher_Match_SinglePackage(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/with-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestPackageSwiftMatcher_Match_RegistryPackageID(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/registry-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestPackageSwiftMatcher_Match_CaseInsensitiveURL(t *testing.T) {
	...
	// Package.swift uses mixed-case URL; Package.resolved uses all-lowercase location.
	// GitHub URLs are case-insensitive so these refer to the same package.
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/case-mismatch-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestPackageSwiftMatcher_Match_MultiplePackagesOnOneLine(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/compact-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestPackageSwiftMatcher_Match_CommentedOutPackageIgnored(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/commented-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestPackageSwiftMatcher_Match_MultilinePackageBlock(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/swift/multiline-package-swift/Package.swift")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
