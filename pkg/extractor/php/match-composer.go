...
/*
ComposerMatcherDependencyMap is here to have access to all extractor.MatcherDependencyMap methods and at the same time having
...
func (matcher ComposerMatcher) GetSourceFile(sourceFile extractor.DepFile) (extractor.DepFile, error) {
...
*/
func (matcher ComposerMatcher) Match(sourceFile extractor.DepFile, packages []extractor.PackageDetails, context extractor.ScanContext) error {
	...
	jsonFile := composerFile{
		Require: ComposerMatcherDependencyMap{
			MatcherDependencyMap: extractor.MatcherDependencyMap{
				...
				Packages:   make([]*extractor.PackageDetails, len(packages)),
			},
		},
