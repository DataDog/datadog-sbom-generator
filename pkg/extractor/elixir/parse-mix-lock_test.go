...
import (
	...
	"github.com/DataDog/datadog-sbom-generator/pkg/extractor/elixir"
...
func TestParseMixLock_FileDoesNotExist(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/does-not-exist")
...
func TestParseMixLock_NoPackages(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/empty.lock")
...
func TestParseMixLock_OnePackage(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/one-package.lock")
...
func TestParseMixLock_TwoPackages(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/two-packages.lock")
...
func TestParseMixLock_Many(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/many.lock")
...
func TestParseMixLock_GitPackages(t *testing.T) {
	...
	packages, err := elixir.ParseMixLock("../fixtures/mix/git.lock")
