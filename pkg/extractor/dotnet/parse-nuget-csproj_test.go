	...
	testutil.ExpectPackages(t, packages, []extractor.PackageDetails{
		{
			...
			IsDirect:         true,
			TargetFrameworks: []string{"net462", "net8.0"},
...
func TestParseNuGetCsproj_SampleApp(t *testing.T) {
	...
	testutil.ExpectPackages(t, packages, []extractor.PackageDetails{
		...
		},
		{
			...
			Ecosystem:        models.EcosystemNuGet,
			IsDirect:         true,
			TargetFrameworks: []string{"net462"},
			DepGroups:        []string{string(models.DepGroupProd)},
			BlockLocation: models.FilePosition{
	...
	testutil.ExpectPackages(t, packages, []extractor.PackageDetails{
		{
			...
			Ecosystem:        models.EcosystemNuGet,
			IsDirect:         true,
			TargetFrameworks: []string{"net7.0"},
			DepGroups:        []string{string(models.DepGroupProd)},
			BlockLocation: models.FilePosition{
	...
	testutil.ExpectPackages(t, packages, []extractor.PackageDetails{
		{
			...
			Ecosystem:        models.EcosystemNuGet,
			IsDirect:         true,
			TargetFrameworks: []string{"net6.0", "net8.0"},
			DepGroups:        []string{string(models.DepGroupProd)},
			BlockLocation: models.FilePosition{
				Line:     models.Position{Start: 11, End: 11},
...
func TestParseNuGetCsproj_Common_CentralVersionManagement_MultipleBuild(t *testing.T) {
	...
	context := extractor.ScanContext{Reporter: r, RootDir: rootDir}
	...
	context = extractor.ScanContext{Reporter: r, RootDir: otherRootDir}
	packages, err = dotnet.ParseNuGetCsprojWithContext(path, context)
	if err != nil {
		t.Errorf("ParseNuGetCsprojWithContext() error = %v", err)
		return
