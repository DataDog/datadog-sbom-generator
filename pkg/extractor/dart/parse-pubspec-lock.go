...
var _ extractor.Extractor = PubspecLockExtractor{}

//nolint:gochecknoinits
func init() {
	extractor.RegisterExtractor(models.PubFilePath, PubspecLockExtractor{})
}

func ParsePubspecLock(pathToLockfile string) ([]extractor.PackageDetails, error) {
	return extractor.ExtractFromFile(pathToLockfile, PubspecLockExtractor{})
}
