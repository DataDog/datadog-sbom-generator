...
func TestRequirementsInMatcher_GetSourceFile_FileDoesNotExist(t *testing.T) {
	...
	lockFile, err := extractor.OpenLocalDepFile("../fixtures/pip/generated-simple.txt")
	if err != nil {
...
func TestRequirementsInMatcher_GetSourceFile(t *testing.T) {
	...
	lockFile, err := extractor.OpenLocalDepFile(basePath + "requirements.txt")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestRequirementsInMatcher_Match_OnePackage(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile("../fixtures/pip/with-in-file/requirements.in")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestRequirementsInMatcher_Match_DuplicateNameDifferentVersions(t *testing.T) {
	...
	sourceFile, err := extractor.OpenLocalDepFile(basePath + "requirements.in")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
