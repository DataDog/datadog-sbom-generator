...
func (e UvLockExtractor) Extract(f extractor.DepFile, context extractor.ScanContext) ([]extractor.PackageDetails, error) {
	...
	if err != nil {
		return []extractor.PackageDetails{}, errors.New("error getting root package")
	}
...
func ParseUvLock(pathToLockfile string) ([]extractor.PackageDetails, error) {
	return extractor.ExtractFromFile(pathToLockfile, UvExtractor)
}

//nolint:gochecknoinits
func init() {
	extractor.RegisterExtractor(models.UvFilePath, UvExtractor)
}
