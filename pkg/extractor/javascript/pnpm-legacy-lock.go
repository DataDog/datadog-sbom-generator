...
func parsePnpmLegacyLock(sourceFile PnpmLegacyLockfile, positions map[string]models.FilePosition, filePath string) []extractor.PackageDetails {
	packages := make([]extractor.PackageDetails, 0, len(sourceFile.Packages))
...
func (e PnpmLockExtractor) extractLegacyPnpm(f extractor.DepFile) ([]extractor.PackageDetails, error) {
