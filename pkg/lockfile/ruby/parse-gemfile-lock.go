...
var GemfileExtractor = GemfileLockExtractor{
	lockfile.WithMatcher{Matchers: []lockfile.Matcher{
		&GemfileMatcher{},
		&GemspecFileMatcher{},
	}},
}
...
func ParseGemfileLock(pathToLockfile string) ([]lockfile.PackageDetails, error) {
	return lockfile.ExtractFromFile(pathToLockfile, GemfileExtractor)
}

//nolint:gochecknoinits
func init() {
	lockfile.RegisterExtractor(models.BundlerFilePath, GemfileExtractor)
}
