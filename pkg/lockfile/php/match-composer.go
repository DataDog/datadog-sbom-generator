...
/*
ComposerMatcherDependencyMap is here to have access to all lockfile.MatcherDependencyMap methods and at the same time having
	...
	jsonFile := composerFile{
		Require: ComposerMatcherDependencyMap{
			MatcherDependencyMap: lockfile.MatcherDependencyMap{
				...
				Packages:   make([]*lockfile.PackageDetails, len(packages)),
			},
		},
