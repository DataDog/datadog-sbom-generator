...
func TestParseNpmLock_v1_FileDoesNotExist(t *testing.T) {
	...
	packages, err := javascript.ParseNpmLock("../fixtures/npm/does-not-exist")
...
func TestParseNpmLock_v1_InvalidJson(t *testing.T) {
	...
	packages, err := javascript.ParseNpmLock("../fixtures/npm/not-json.txt")
...
func TestParseNpmLock_v1_NoPackages(t *testing.T) {
	...
	packages, err := javascript.ParseNpmLock("../fixtures/npm/empty.v1.json")
	if err != nil {
...
func TestParseNpmLock_v1_SamePackageDifferentGroups(t *testing.T) {
	...
	packages, err := javascript.ParseNpmLock("../fixtures/npm/same-package-different-groups.v1.json")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
