...
func parseLine(path string, line string, lineNumber int, lineOffset int, columnStart int, columnEnd int) lockfile.PackageDetails {
...
func parseRequirementsTxt(f lockfile.DepFile, requiredAlready map[string]struct{}) ([]lockfile.PackageDetails, error) {
	...
	lastPkg := lockfile.PackageDetails{}
	lastPkgKey := ""
