...
func TestRequirementsTxtExtractor_ShouldExtract(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			e := python.RequirementsTxtExtractor{}
...
func TestParseRequirementsTxt_FileDoesNotExist(t *testing.T) {
	...
	packages, err := python.ParseRequirementsTxt("../fixtures/pip/does-not-exist")
...
func TestParseRequirementsTxt_Empty(t *testing.T) {
	...
	packages, err := python.ParseRequirementsTxt("../fixtures/pip/empty.txt")
	if err != nil {
...
func TestParseRequirementsTxt_CommentsOnly(t *testing.T) {
	...
	packages, err := python.ParseRequirementsTxt("../fixtures/pip/only-comments.txt")
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestParseRequirementsTxt_FileFormatExample(t *testing.T) {
	...
	packages, err := python.ParseRequirementsTxt(sourcePath)
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
...
func TestParseRequirementsTxt_WithBadROption(t *testing.T) {
	...
	packages, err := python.ParseRequirementsTxt("../fixtures/pip/with-bad-r-option.txt")
