...
func TestParseGoLock_FileDoesNotExist(t *testing.T) {
	...
	packages, err := golang.ParseGoLock("../fixtures/go/does-not-exist")
...
func TestParseGoLock_Invalid(t *testing.T) {
	...
	packages, err := golang.ParseGoLock("../fixtures/go/not-go-mod.txt")
...
func TestParseGoLock_NoPackages(t *testing.T) {
	...
	packages, err := golang.ParseGoLock("../fixtures/go/empty.mod")
...
func TestParseGoLock_WithPathMajor(t *testing.T) {
	...
	packages, err := golang.ParseGoLock(path)
	if err != nil {
		t.Errorf("Got unexpected error: %v", err)
	}
