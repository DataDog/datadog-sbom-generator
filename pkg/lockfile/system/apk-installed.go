...
func parseApkPackageGroup(group []string) lockfile.PackageDetails {
...
func ParseApkInstalled(pathToLockfile string) ([]lockfile.PackageDetails, error) {
	return lockfile.ExtractFromFile(pathToLockfile, ApkInstalledExtractor{})
}
...
func alpineReleaseExtractor(opener lockfile.DepFile) (string, error) {
...
var _ lockfile.Extractor = ApkInstalledExtractor{}

var ApkExtractor = ApkInstalledExtractor{}

//nolint:gochecknoinits
func init() {
	lockfile.RegisterExtractor(models.ApkFilePath, ApkExtractor)
}
