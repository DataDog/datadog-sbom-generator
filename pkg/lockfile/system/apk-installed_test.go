...
import (
	...
	"github.com/DataDog/datadog-sbom-generator/pkg/lockfile/system"
...
func TestParseApkInstalled_FileDoesNotExist(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/does-not-exist")
...
func TestParseApkInstalled_Empty(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/empty_installed")
...
func TestParseApkInstalled_NotAnInstalled(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/not_installed")
...
func TestParseApkInstalled_Malformed(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/malformed_installed")
...
func TestParseApkInstalled_Single(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/single_installed")
...
func TestParseApkInstalled_Shuffled(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/shuffled_installed")
...
func TestParseApkInstalled_Multiple(t *testing.T) {
	...
	packages, err := system.ParseApkInstalled("../fixtures/apk/multiple_installed")
