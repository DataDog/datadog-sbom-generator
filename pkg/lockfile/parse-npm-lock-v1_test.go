	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			DepGroups:      []lockfile.DepGroup{"prod"},
		},
	})
}
	...
	expectPackages(t, packages, []lockfile.PackageDetails{
		{
			...
			Ecosystem:      lockfile.NpmEcosystem,
			CompareAs:      lockfile.NpmEcosystem,
			DepGroups:      []lockfile.DepGroup{lockfile.DepGroupOptional, lockfile.DepGroupDev},
		},
		{
			Name:           "supports-color",
			Version:        "5.5.0",
			...
			Ecosystem:      lockfile.NpmEcosystem,
			CompareAs:      lockfile.NpmEcosystem,
			DepGroups:      []lockfile.DepGroup{lockfile.DepGroupOptional, lockfile.DepGroupProd},
		},
	})
}
